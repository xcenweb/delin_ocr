<template>
    <v-app>
        <!-- pc 左侧导航栏 -->
        <v-navigation-drawer style="top:0; height: calc(100% - env(safe-area-inset-top));" :rail="true"
            :mobile-breakpoint="600" :elevation="3" :touchless="true">
        ...
        <v-system-bar style="height: env(safe-area-inset-top);"></v-system-bar>

        <v-main class="d-flex flex-column" style="--v-layout-top: 0px; --v-layout-bottom: 0px;">
